...
* **Workflow:** Solutions are automatically synced using LeetHub/LeetSync.

## 📁 Repository Structure
To focus on conceptual learning, I organize my solutions by algorithmic pattern and data structure rather than just problem numbers:
...
| # | Title | Difficulty | Topic | Solution | Time | Space |
|---|---|---|---|---|---|---|
| 1 | [Two Sum](https://leetcode.com/problems/two-sum/) | 🟢 Easy | Arrays & Hashing | [Code](./Arrays_and_Hashing/1_Two_Sum.py) | `O(n)` | `O(n)` |
...
| ------- | ------- |
| [0023-merge-k-sorted-lists](https://github.com/roshankumar8368/leetcode_solutions/tree/master/0023-merge-k-sorted-lists) |
| [0347-top-k-frequent-elements](https://github.com/roshankumar8368/leetcode_solutions/tree/main/0347-top-k-frequent-elements/) | Medium |
...
| [0035-search-insert-position](https://github.com/roshankumar8368/leetcode_solutions/tree/main/0035-search-insert-position/) | Easy |
